...
```{block, type = "info"}
Lab 7 and 8 introduce the students to probability. Firstly, in lab 7, we introduce binomial probability and then in lab 8 we introduce normal distribution probability. Again, we used an informal video by the course lead to suppport students in understanding the theoretical concepts behind probability. 
```

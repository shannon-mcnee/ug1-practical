...
### Lab 1 
Pre-lab - watch video as intro to open science[Intro to open science](https://www.youtube.com/watch?v=1rFWeTryiW4&feature=youtu.be) 
In-lab -  What is academic communication and why is it important? What forms does it take? Introduce essay question. Academic writing task where they have to differentiate between academic and more informal communication. Replication task as shown on slack and introduce dataset.
Post-lab - formative task where the upload plan to address RQ given as well as rewrite sentences to make more academic in tone.

### Lab 2
Pre-lab - watch intro video to RStudio
In-lab - Discuss  sources and plans for essays in groups and do academic sources tasks (see lab 2 slides). Staff led introduction to RStudio using scripts developed

...
<img src="04-lab04_files/figure-html/create plot-1.png" alt="**CAPTION THIS FIGURE!!**" width="100%" />
<p class="caption">(\#fig:create plot)**CAPTION THIS FIGURE!!**</p>
</div>
